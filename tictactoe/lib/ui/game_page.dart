...
import 'package:tictactoe/ui/field.dart';
import 'package:tictactoe/ui/game_presenter.dart';
      ...
      body: Column(
        children: <Widget>[
          Padding(
            ...
            child: Text("You are playing as X(HUMAN)", style: TextStyle(fontSize: 25),),
          ),
          Expanded(
